		...
		<div class="row">
			<div  class="col-sm-12">
				<div class="card text-left">
					...
					<div class="card-body">
						<span class="btn btn-primary" data-toggle="modal" data-target="#agreganuevosDatos">Agregar nuevo
...
<script type="text/javascript">
	...
	function eliminarDatos(idjuego){
		alertify.confirm('Eliminar un juego', '¿Seguro de eliminar este juego pro :C?', function()
		{   
			$.ajax({
        	type:"POST",
        	data:"idjuego="+ idjuego,
